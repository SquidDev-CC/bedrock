...
export default function(callbacks: ICallbacks): void;
...
/**
 * Creates and starts a new computer.
 */
export type ComputerFactory = (
  id: number, label: string | null, colour: boolean,
...
export interface ICallbacks {
   ...
   *
   * @param factory The computer factory
   */
  setFactory(factory: ComputerFactory): void;
...
*/
  ...
  setTick(callback: () => void): void;

  queueImmediate(callback: () => void): void;
}
